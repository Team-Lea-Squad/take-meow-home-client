  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col w-full border border-line-medium rounded-lg overflow-hidden">
        <div className="flex items-center w-full p-600 border-b border-line-medium justify-between cursor-pointer gap-2">
          <div className="w-full">서울 성동구 행당동 318-36</div>
